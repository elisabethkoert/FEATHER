...
1. **[[Getting Started – Installation & Toolbox Setup|User-Guide-Getting-Started]]**
...
2. **[[Getting Started with Git|User-Guide-Git-Basics]]**
...
3. **[[How FEATHER Works (Big Picture)|User-Guide-How-FEATHER-Works]]**
...
5. Keep these two open as references while you work:
   - **[[GUI Reference|User-Guide-GUI-Reference]]** — explains every button
     and field in the FEATHER GUIs (wave-picking, calibration input, user
     annotation tables, etc.)
   - **[[FAQ / Troubleshooting|User-Guide-FAQ]]** — common error messages
     and what they mean
...
**[[Developer Guide|Home/Developer-Guide]]**.
