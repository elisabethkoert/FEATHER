...
% icme\calculateEvokedSpikeRate calculates the evoked spikeRate [Hz] in the
% given time window for all stimuli defined in the stim criteria array by substracting the spike rate in the
% time window before th trigger
% input:
%   obj (icme)
...
% output
%   meanEvokedSpikeRate 32xn_stimuli array with mean evoked spike rates caclulated in the
